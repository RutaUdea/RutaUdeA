        ...
        map.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                if (actualPosition){
                    ...
                    String url ="https://maps.googleapis.com/maps/api/directions/json?origin="+latitudOrigen+","+longitudOrigen+"&destination=6.267825,-75.568334&key=AIzaSyC3uXb8BWPtae4u_KQWFa88XCVkcsH8h9I";
